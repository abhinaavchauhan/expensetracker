...
public final class ExpenseDao_Impl implements ExpenseDao {
      ...
      public List<ExpenseEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ExpenseEntity(_tmpAmount,_tmpCategory,_tmpNote,_tmpDate,_tmpType);
            final int _tmpId;
  ...
  @Override
  public List<ExpenseEntity> getExpensesByDateRangeSync(final long startDate, final long endDate) {
    final String _sql = "SELECT * FROM expenses WHERE date BETWEEN ? AND ? ORDER BY date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, startDate);
