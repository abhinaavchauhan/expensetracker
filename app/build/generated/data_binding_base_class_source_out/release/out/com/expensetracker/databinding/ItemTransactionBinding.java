...
public final class ItemTransactionBinding implements ViewBinding {
  ...
  private ItemTransactionBinding(@NonNull LinearLayout rootView, @NonNull View iconBg,
      @NonNull ImageView ivCategory, @NonNull TextView tvAmount, @NonNull TextView tvCategory,
  ...
  public static ItemTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTransactionBinding((LinearLayout) rootView, iconBg, ivCategory, tvAmount,
          tvCategory, tvDate, tvNote);
    }
